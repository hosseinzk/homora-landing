/* ═══════════════════════════════
   ...
   With real customer profile pictures
   ═══════════════════════════════ */

const REVIEWS = [
  {
    name: 'Samane Gazerani',
    photo: '/images/reviewers/samane-gazerani.jpg',
    initials: 'SG',
    date: 'April 21, 2026',
  ...
  },
  {
    ...
    photo: '/images/reviewers/saeed-hassanabadi.jpg',
    initials: 'SH',
  ...
  {
    name: 'Rose Mac',
    photo: '/images/reviewers/rose-mac.jpg',
    initials: 'RM',
  ...
  {
    name: 'Mehdi Najafi',
    photo: '/images/reviewers/mehdi-najafi.jpg',
    initials: 'MN',
  ...
  {
    name: 'Neda Aghaei',
    photo: '/images/reviewers/neda-aghaei.jpg',
    initials: 'NA',
  ...
  {
    name: 'Asa Nyman',
    photo: '/images/reviewers/asa-nyman.jpg',
    initials: 'AN',
  ...
  },
  {
    ...
    photo: '/images/reviewers/majid-yoosef-sorbi.jpg',
    initials: 'MS',
    date: 'August 19, 2025',
...
const STAR_ICON = `<svg width="15" height="15" viewBox="0 0 24 24" fill="#FBBC05" style="flex-shrink:0;"><path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z"/></svg>`
...
function renderReviews(opts = {}) {
  ...
  <section class="testimonials-bg">
    <div class="section-inner">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:14px;margin-bottom:32px;flex-wrap:wrap;" class="animate-in">
        <div style="display:flex;gap:2px;">${STAR_ICON.repeat(5)}</div>
        <span style="font-weight:700;font-size:18px;">5.0</span>
        <span style="color:var(--text-muted);font-size:14px;">based on real Google reviews</span>
        ${GOOGLE_LOGO}
      </div>

      <div class="testimonials-grid" style="grid-template-columns:repeat(${cols},1fr);gap:20px;">
        ${list.map((r, i) => `
          <div class="testimonial-card animate-in" style="animation-delay:.${(i+1)*5}s">
            <div style="display:flex;align-items:center;gap:12px;margin-bottom:14px;">
              <img src="${r.photo}" alt="${r.name}" loading="lazy" style="width:46px;height:46px;border-radius:50%;object-fit:cover;flex-shrink:0;border:2px solid #fff;box-shadow:0 2px 8px rgba(0,0,0,0.08);"/>
              <div style="flex:1;min-width:0;">
                <div class="testimonial-name" style="display:flex;align-items:center;gap:6px;font-size:14.5px;">${r.name} ${GOOGLE_LOGO}</div>
                <div class="testimonial-role" style="font-size:12px;">${r.date}</div>
              </div>
            </div>
            <div style="display:flex;gap:1px;margin-bottom:10px;">${STAR_ICON.repeat(5)}</div>
